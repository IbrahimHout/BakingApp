...
public class RecipesActivityTest {
    ...
    public void recipesActivityTest() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.id_text), withText("0 - Recipe Introduction"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.recyclerSteps),
                                        0),
                                0),
                        isDisplayed()));
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(withId(R.id.buttonIngredient), withText("Ingredients"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.frameMaster),
                                        0),
                                0),
                        isDisplayed()));
